...
class CarModelInline(admin.TabularInline):
    ...
    # Display these fields in the inline form
...
class CarMakeAdmin(admin.ModelAdmin):
    ...
    # Display name and description in the list
...
class CarModelAdmin(admin.ModelAdmin):
    list_display = (
        ...
        "type",
        "year",
    )  # Display these fields in the list
    search_fields = (
        "name",
        "car_make__name",
    )  # Search by CarModel name or CarMake name
